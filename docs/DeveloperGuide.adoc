...
.. Prerequisites: No commands have been entered yet.
...
.. Prerequisites: No commands have been entered yet and the current view is the main list. There is at least one item in the main list that is expiring within 50 days.
...
.. Prerequisite: No commands have been entered yet.
.. Test case: `undo` +
