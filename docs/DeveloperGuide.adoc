...
This feature allows users to tag specific items in the list. Items can only have a maximum of 5 tags and all of the tags are parsed in Sentence-Case and must not be more than 20 characters long each. If the user simply enters `tag`, all the tags in the current list view will be collected and displayed to the user.
