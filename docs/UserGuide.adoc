...
* `*transfer*|1` : moves the 1st item from the tracking list (main list) to the replenish list
...
// tag::transfer[]
==== Transferring an item from one list to another: `transfer`
Transfers items from main list to replenish list, or from replenish list to main list.

===== Transferring an item from the main list to the replenish list

[TIP]
Use this to transfer any expired items (tagged as `#Expired`  by the system) to the replenish list.
...
===== Transferring an item from the replenish list to the main list
Format: `transfer|<index>|<expiry date>[|quantity]`

Examples:

* `transfer|3|29/3/2020` (without quantity) +
Transfers the 3rd item from the replenish list to the main list with expiry date `29/3/2020` and quantity `1`

* `transfer|2|11/2/2020|4` +
