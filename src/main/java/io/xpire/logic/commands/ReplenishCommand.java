...
import io.xpire.commons.exceptions.IncompatibleModelException;
...
public class ReplenishCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        List<XpireItem> lastShownList;
        //try {
            lastShownList = model.getFilteredItemList();
        //} catch (
        ...
        Item item = adaptItemToToBuy(targetItem);
        this.item = item;
    ...
    private Item adaptItemToToBuy(XpireItem item) {
